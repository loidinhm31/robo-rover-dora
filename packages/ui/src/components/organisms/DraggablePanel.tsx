...
import { useDraggableWindow } from "@robo-fleet/ui/hooks";
...
export const DraggablePanel: React.FC<DraggablePanelProps> = ({
  ...
  const { position, isDragged, handleMouseDown, handleTouchStart, handleTouchMove, handleTouchEnd } = useDraggableWindow({
    initialPosition,
  });
